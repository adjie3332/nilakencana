        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <h3 class="title-5 m-b-35">Struktur Organisasi</h3>
                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM struktur WHERE deskripsi LIKE '%$search%'";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $counter . "</td>";
                                            echo "<td>";
                                            echo "<span class='block-email'>" . $row["deskripsi"] . "</span>";
                                            echo "</td>";
                                            echo "<td>";
                                            echo "<img src='folder_gambar/" . $row["struktur"] . "' alt='Gambar' width='100' height='100'>";
                                            echo "</td>";
                                            echo "<td>" . $row["date"] . "</td>";
                                            echo "<td>";
