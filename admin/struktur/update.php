                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Update</strong> Data Struktur Organisasi
                                    </div>
                                    <div class="card-body card-block">
                                        ...
                                        $sql = "SELECT * FROM struktur WHERE id = '$id'";
                                            ...
                                            <form action="proses_update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <textarea name="deskripsi" id="deskripsi" rows="9" placeholder="Masukkan deskripsi" class="form-control"><?php echo $row['deskripsi']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="gambar" class="form-control-label">Gambar Struktur</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="file" id="gambar" name="gambar" class="form-control-file">
                                                        <img src="<?php echo "folder_gambar/".$row['struktur']; ?>" alt="Gambar" width="200px" height="auto">
                                                    </div>
                                                </div>
