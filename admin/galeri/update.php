                                            ...
                                            <form action="proses_update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="judul" name="judul" placeholder="Masukkan judul" class="form-control" value="<?php echo $row['judul']; ?>">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        ...
                                                        <img src="<?php echo "folder_gambar/".$row['gambar']; ?>" alt="Gambar" width="200px" height="auto">
                                                    </div>
                                                </div>
