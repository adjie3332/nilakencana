        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <h3 class="title-5 m-b-35">Galeri</h3>
                        <div class="table-data__tool">
                            <div class="table-data__tool-left">
                                <a href="insert.php" class="au-btn au-btn-icon au-btn--green au-btn--small">
                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM galeri WHERE judul LIKE '%$search%'";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $counter . "</td>";
                                            echo "<td>";
                                            echo "<span class='block-email'>" . $row["judul"] . "</span>";
                                            echo "</td>";
                                            echo "<td>" . $row["deskripsi"] . "</td>";
                                            echo "<td>";
                                            echo "<img src='folder_gambar/" . $row["gambar"] . "' alt='Gambar' width='100' height='100'>";
                                            echo "</td>";
                                            echo "<td>" . $row["date"] . "</td>";
                                            echo "<td>";
                                            echo "<div class='table-data-feature'>";
                                            echo "<button class='item' data-toggle='tooltip' data-placement='top' title='Edit'>";
                                            echo "<a href='update.php?id=" . $row["id"] . "'><i class='zmdi zmdi-edit'></i></a>";
                                            echo "</button>";
                                            echo "<button class='item' data-toggle='tooltip' data-placement='top' title='Delete'>";
                                            echo "<a href='delete.php?id=" . $row["id"] . "'><i class='zmdi zmdi-delete'></i></a>";
                                            echo "</button>";
                                            echo "</div>";
                                            echo "</td>";
                                            echo "</tr>";
