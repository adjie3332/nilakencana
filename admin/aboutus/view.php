                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM aboutus WHERE nama LIKE '%$search%'";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $counter . "</td>";
                                            echo "<td>";
                                            echo "<span class='block-email'>" . $row["nama"] . "</span>";
                                            echo "</td>";
                                            echo "<td>" . $row["keterangan"] . "</td>";
                                            echo "<td>";
                                            echo "<img src='folder_gambar/" . $row["foto"] . "' alt='Gambar' width='100' height='100'>";
                                            echo "</td>";
                                            echo "<td>" . $row["date"] . "</td>";
                                            echo "<td>";
