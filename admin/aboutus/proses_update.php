...
if ($_FILES['gambar']['name'] != '') {
    ...
    $sql = "UPDATE aboutus SET nama = '$judul', keterangan = '$deskripsi', foto = '$gambar', date = '$tanggal_diperbarui' WHERE id = '$id'";
} else {
    // Query update data tanpa gambar
    $sql = "UPDATE aboutus SET nama = '$judul', keterangan = '$deskripsi', date = '$tanggal_diperbarui' WHERE id = '$id'";
}
